...
//utils
    ...
    function getHash() {
        return decodeURI(window.location.hash.replace(/^#\/?/, "")) || "Show Intent";
    }
...
//demos
    var demos = {
        ...
        "Intent Based Network": [
            ...
            {
                name: "Show Topology",
                jsfile: "./ShowTopology/topology.js"
            },
            // {
            //     name: "Strategy Management",
            //     jsfile: "./Management/management.js"
            // },
            {
                name: "Policy optimization",
                jsfile: "./Policy_optimization/optimization.js"
            }
        ]
/*        "Interaction Demos": [
            {
